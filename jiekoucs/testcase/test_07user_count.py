"""
-- coding: utf-8 --
@Time : 2020/4/16 20:36
@Author : jcoool
@Site : 
@File : test_07user_count.py
@Software: PyCharm
"""
import os
import unittest
...
@ddt
class Test_user_count(unittest.TestCase,TestBase):
    excel = HandleExcel(os.path.join(DATA_DIR, "apicases.xlsx"), "user_count")
    ...
    def test_testcases(self, case):
        # 第一步：准备用例数据
        # if判断数据中是否需要替换数据
        if '#username#' in case['url'] or '#username#' in case['expected']:
